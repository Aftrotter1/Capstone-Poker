...
import random
from . import pokerhands as pokerhands
...
class cnallen4(Strategy): ## want to be agressive early, play conservative near money line, check raise if we bet first with a good hand
